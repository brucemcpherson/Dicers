  ...
  */
  ns.Chunking = function () {
    ...
    */
    ...
    /**
    * whether zipping.unzipping should be done
    * @param {boolean} crushing the max size
    * @return {Chunking} self
    */
    self.setCrushing = function (crushing) {
      crushing_ = crushing;
      return self;
    };
    ...
    */
    self.removeBigProperty = function (propKey) {
      ...
      // remove the master property first so nobody finds it
      // mid delete of the others.
    ...
    */
    self.zip = function (crushThis) {
      ...
      return crushing_ ? 
        Utilities.base64Encode(Utilities.zip ([Utilities.newBlob(crushThis)]).getBytes()) :
        crushThis;
    };
